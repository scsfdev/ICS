...
public class StockInActivity extends Activity
    ...
    private static final String TAG = "ICS-STK-IN";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etLocId = findViewById(R.id.etSILoc);
        etPartNo = findViewById(R.id.etSIPNo);
        etQty = findViewById(R.id.etSIQty);
        ...
        etLocId.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if(!hasFocus)
                {
                    getLoaderManager().restartLoader(1, null, StockInActivity.this);
                }
            }
        });
    ...
    public void onLoadFinished(android.content.Loader<String> loader, String data) {
        try {
            ...
            if(loader.getId() == 0){
                // Return result from Saving Stock In.
                ...
                if (isOk) {
                    // Save successfully.
                    // Clear screen.
                    Toast.makeText(this, "Stock in successfully.", Toast.LENGTH_SHORT).show();
